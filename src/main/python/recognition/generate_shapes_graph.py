...
def generate_shape_graph(tf, points):
    ...
    is_stretch = tf.random_uniform([1], minval=0, maxval=2, dtype=tf.float32, seed=None, name="is_stretch")
    is_rotate = tf.random_uniform([1], minval=0, maxval=2, dtype=tf.float32, seed=None, name="is_rotate")
